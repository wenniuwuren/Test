...
//        BeanFactory bf = new XmlBeanFactory(new ClassPathResource("testCustomizeBean.xml"));
        ApplicationContext bf = new ClassPathXmlApplicationContext("testCustomizeBean.xml");
